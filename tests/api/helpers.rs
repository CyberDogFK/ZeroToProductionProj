...
impl TestApp {
    pub async fn dispatch_all_pending_emails_with_time_calculation(&self) {
        loop {
    ...
    pub fn get_confirmation_links(&self, email_request: &wiremock::Request) -> ConfirmationLinks {
        let params: HashMap<String, String> =
            email_request.url.query_pairs().into_owned().collect();
        ...
        let html = get_link(params["bodyHtml"].as_str());
        let plain_text = get_link(params["bodyText"].as_str());
...
pub async fn spawn_app() -> TestApp {
    ...
    println!("DATABASE NAME {}", &configuration.database.database_name);
